...
export default function Manufacturers() {
  return (
    <>
      <Head>
        <title>{ METADATA.titleManufacturers}</title>
        <meta name="description" content={   METADATA.descriptionManufacturers}/>
        <meta property="og:image" content={  METADATA.imgManufacturers}/>
        <meta property="og:title" content={ METADATA.titleManufacturers}/>
        <meta property="og:description" content={ METADATA.descriptionManufacturers}/>

      </Head>
      <Layout>
        <h1 className={dmSerifDisplay + " " + styles.about_title}>Manufacturers</h1>
